...
define('global_mysql_configuration_table', 'ebdb.phpmyreservation_configuration');
define('global_mysql_users_table', 'ebdb.phpmyreservation_users');
define('global_mysql_reservations_table', 'ebdb.phpmyreservation_reservations');
