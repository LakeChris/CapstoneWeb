...
// MySQL details
define('global_mysql_server', 'aaylum6h7nz1z1.c6f0fyzcst2v.us-east-2.rds.amazonaws.com');
define('global_mysql_user', 'cubbybuddy');
define('global_mysql_password', 'cubbyone');
define('global_mysql_database', 'ebdb');
...
define('global_title', 'CubbyBuddy');
// Organization. Used in page title and header, and as sender name in reservation reminder emails
define('global_organization', 'Occupancy Management System');


define('main_title','CubbyBuddy');
