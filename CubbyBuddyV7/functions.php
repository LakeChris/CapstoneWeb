...
{
	//$query = mysqli_query($con,"SELECT * FROM users WHERE password='$pass' AND username='$user'");
...
{
	if(preg_match('/^[a-z Ã¦Ã¸Ã¥Ã†Ã˜Ã…]{2,12}$/i', $user_name))
	{
		return(true);
	}
}
...
function user_name_exists($user_name)
{
	...
	$query = mysqli_query($con, "SELECT * FROM " . global_mysql_users_table . " WHERE user_name='$user_name'")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysql_error()) . '</span>');
...
function user_email_exists($user_email)
{
	...
	$con = mysqli_connect(global_mysql_server, global_mysql_user, global_mysql_password)or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysql_error()) . '</span>');
	$query = mysqli_query($con, "SELECT * FROM " . global_mysql_users_table . " WHERE user_email='$user_email'")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysql_error()) . '</span>');
...
function login($user_email, $user_password, $user_remember)
{
	...
	$query = mysqli_query($con, "SELECT * FROM ".global_mysql_users_table." WHERE user_email='$user_email' AND user_password='$user_password' OR user_email='$user_email' AND user_password='$user_password'") or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysql_error()) . '</span>');
...
function check_login()
{
	if(isset($_SESSION['logged_in']))
	{
		...
		$query = mysqli_query($con, "SELECT * FROM " . global_mysql_users_table . " WHERE user_id='$user_id'")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysql_error()) . '</span>');
...
function create_user($user_name, $user_email, $user_password, $user_secret_code)
{
	...
	{
		$con = mysqli_connect(global_mysql_server, global_mysql_user, global_mysql_password)or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysql_error()) . '</span>');
		$query = mysqli_query($con, "SELECT * FROM " . global_mysql_users_table . "")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysql_error()) . '</span>');
		...
		mysqli_query($con, "INSERT INTO " . global_mysql_users_table . " (user_is_admin,user_email,user_password,user_name,user_reservation_reminder) VALUES ($user_is_admin,'$user_email','$user_password','$user_name','0')")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysql_error()) . '</span>');
...
function read_reservation($week, $day, $time)
{
	...
	$con = mysqli_connect(global_mysql_server, global_mysql_user, global_mysql_password)or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysql_error()) . '</span>');
	$query = mysqli_query($con, "SELECT * FROM " . global_mysql_reservations_table . " WHERE reservation_week='$week' AND reservation_day='$day' AND reservation_time='$time'");
...
{
	$con = mysqli_connect(global_mysql_server, global_mysql_user, global_mysql_password)or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysql_error()) . '</span>');
	$query = mysqli_query($con,"SELECT * FROM " . global_mysql_reservations_table . " WHERE reservation_week='$week' AND reservation_day='$day' AND reservation_time='$time'")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysql_error()) . '</span>');
	$reservation = mysqli_fetch_array($query);
...
function make_reservation($week, $day, $time)
{
	...
	else
	{
		...
		if(mysqli_num_rows($query) < 1)
		{
			...
			mysqli_query($con, "INSERT INTO " . global_mysql_reservations_table . " (reservation_made_time,reservation_year,reservation_week,reservation_day,reservation_time,reservation_price,reservation_user_id,reservation_user_email,reservation_user_name) VALUES (now(),'$year','$week','$day','$time','$price','$user_id','$user_email','$user_name')")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysql_error()) . '</span>');
...
function delete_reservation($week, $day, $time)
{
	...
	else
	{
		...
		{
			mysqli_query($con, "DELETE FROM " . global_mysql_reservations_table . " WHERE reservation_week='$week' AND reservation_day='$day' AND reservation_time='$time'")or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysql_error()) . '</span>');
